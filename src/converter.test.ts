...
test('string attributes', async t => {
  await testAttributeType(t, 'string', 'String')
})

test('integer attributes', async t => {
  await testAttributeType(t, 'integer', 'Int')
})

test('float attributes', async t => {
  await testAttributeType(t, 'number', 'Float')
})

test('boolean attributes', async t => {
  await testAttributeType(t, 'boolean', 'Boolean')
})

test('fail on unknown types attributes', async t => {
...
test('required attributes', async test => {
  const simpleType = {
    $id: 'Array',
    type: 'object',
    properties: {
...
test('Unknown $ref attribute type', async t => {
  const simpleType = {
    $id: 'Ref',
    type: 'object',
    properties: {
...
test('Known $ref attribute type', async test => {
  const otherType = {
    $id: 'OtherType',
    type: 'object',
    properties: {
...
test('Known $ref array attribute type', async test => {
  const otherType = {
    $id: 'OtherType',
    type: 'object',
    properties: {
...
test('Circular $ref attribute types', async test => {
  const leftType = {
    $id: 'Left',
    type: 'object',
    properties: {
...
test('Enumeration attribute types', async test => {
  const personType = {
    $id: 'Person',
    type: 'object',
    properties: {
...
test('Enumeration attribute with forbidden characters', async test => {
  const personType = {
    $id: 'Person',
    type: 'object',
    properties: {
...
test('Enumeration attribute with comparison symbols', async test => {
  const personType = {
    $id: 'Comparator',
    type: 'object',
    properties: {
...
test('Enumeration attribute with numeric keys', async test => {
  const personType = {
    $id: 'Person',
    type: 'object',
    properties: {
...
test('Enumeration attribute with unsupported type', async t => {
  const personType = {
    $id: 'Person',
    type: 'object',
    properties: {
...
test('Enumeration conversion function', async test => {
  const personType = {
    $id: 'Person',
    type: 'object',
    properties: {
...
test('map switch schemas to unions', async test => {
  const parentType = {
    $id: 'Parent',
    type: 'object',
    properties: {
